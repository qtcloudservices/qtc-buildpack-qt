...
./configure --prefix=/app/.qtcs/Qt/$MAJOR_VERSION/gcc_64/ -opensource -confirm-license -no-xcb -no-compile-examples -skip qtmultimedia -skip qtsensors -skip qtscript -skip qtwebkit
make
make install
